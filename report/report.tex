...
\begin{document} 
	...
	\section{Results}
		...
		\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]
			\textbf{Question 1: } Due to its mainstream adoption in traditional financial markets by both institutional and retail investors, \textit{\textbf{does Bitcoin’s price follow stock market movements}} (in particular, the S\&P 500)? Is Bitcoin truly a new investment asset, or is its price so deeply entangled with traditional investments that it has lost its novelty?
		\end{tcolorbox}
		\subsubsection{The Effect of Missing Values for Question 1}
		\subsection{Question 2}
		Recall that our first question of study is the following: 
		\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black]
			\textbf{Question 2: } How do the price movements of Bitcoin proportionally affect native or meme coins? In particular, \textbf{\textit{are meme coins more affected by the changes in the value of Bitcoin than native coins are?}}
		\end{tcolorbox}
		\subsubsection{The Effect of Missing Values for Question 1}
	\section{Conclusion}
