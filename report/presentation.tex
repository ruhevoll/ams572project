...
\begin{document}
	...
	\begin{frame}{Question 1 Results}
		\[
		\hat{\rho} = 0.3542,\quad p = 4.79\times10^{-16}.
		\]
		...
		\begin{itemize}
			\item MCAR: \(\hat{\rho}_{MCAR}=0.3807\)
			\item MNAR: \(\hat{\rho}_{MNAR}=0.2795\)
		\end{itemize}
	...
	\begin{frame}{Question 2 Results}
		...
		$$\beta_3 = 0.4473,\quad p < 2\times10^{-16}.$$
		...
		Missing data effects:
		\begin{itemize}
			\item MCAR: $\beta_{3,MCAR} = 0.4665$
			\item MNAR: $\beta_{3,MNAR} = 0.2213$
		\end{itemize}
	\end{frame}
